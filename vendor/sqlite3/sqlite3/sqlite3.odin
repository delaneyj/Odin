...
foreign lib {
	...
	*/
	sqlite3_close    :: proc(^sqlite3) -> i32 ---
	sqlite3_close_v2 :: proc(^sqlite3) -> i32 ---
}
...
*/
sqlite3_callback :: proc "c" (rawptr, i32, ^cstring, ^cstring) -> i32
...
sqlite3_file :: struct {
	pMethods: ^sqlite3_io_methods, /* Methods for an open file */
}

sqlite3_io_methods :: struct {
	iVersion:               i32,
	xClose:                 proc "c" (^sqlite3_file) -> i32,
	xRead:                  proc "c" (_: ^sqlite3_file, _: rawptr, iAmt: i32, iOfst: sqlite3_int64) -> i32,
	xWrite:                 proc "c" (_: ^sqlite3_file, _: rawptr, iAmt: i32, iOfst: sqlite3_int64) -> i32,
	xTruncate:              proc "c" (_: ^sqlite3_file, size: sqlite3_int64) -> i32,
	xSync:                  proc "c" (_: ^sqlite3_file, flags: i32) -> i32,
	xFileSize:              proc "c" (_: ^sqlite3_file, pSize: ^sqlite3_int64) -> i32,
	xLock:                  proc "c" (^sqlite3_file, i32) -> i32,
	xUnlock:                proc "c" (^sqlite3_file, i32) -> i32,
	xCheckReservedLock:     proc "c" (_: ^sqlite3_file, pResOut: ^i32) -> i32,
	xFileControl:           proc "c" (_: ^sqlite3_file, op: i32, pArg: rawptr) -> i32,
	xSectorSize:            proc "c" (^sqlite3_file) -> i32,
	xDeviceCharacteristics: proc "c" (^sqlite3_file) -> i32,

	/* Methods above are valid for version 1 */
	xShmMap:     proc "c" (_: ^sqlite3_file, iPg: i32, pgsz: i32, _: i32, _: ^rawptr) -> i32,
	xShmLock:    proc "c" (_: ^sqlite3_file, offset: i32, n: i32, flags: i32) -> i32,
	xShmBarrier: proc "c" (^sqlite3_file),
	xShmUnmap:   proc "c" (_: ^sqlite3_file, deleteFlag: i32) -> i32,

	/* Methods above are valid for version 2 */
	xFetch:   proc "c" (_: ^sqlite3_file, iOfst: sqlite3_int64, iAmt: i32, pp: ^rawptr) -> i32,
	xUnfetch: proc "c" (_: ^sqlite3_file, iOfst: sqlite3_int64, p: rawptr) -> i32,
}
...
sqlite3_vfs :: struct {
	...
	xOpen:         proc "c" (_: ^sqlite3_vfs, zName: sqlite3_filename, _: ^sqlite3_file, flags: i32, pOutFlags: ^i32) -> i32,
	xDelete:       proc "c" (_: ^sqlite3_vfs, zName: cstring, syncDir: i32) -> i32,
	xAccess:       proc "c" (_: ^sqlite3_vfs, zName: cstring, flags: i32, pResOut: ^i32) -> i32,
	xFullPathname: proc "c" (_: ^sqlite3_vfs, zName: cstring, nOut: i32, zOut: cstring) -> i32,
	xDlOpen:       proc "c" (_: ^sqlite3_vfs, zFilename: cstring) -> rawptr,
	xDlError:      proc "c" (_: ^sqlite3_vfs, nByte: i32, zErrMsg: cstring),
	xDlSym:        proc "c" (_: ^sqlite3_vfs, _: rawptr, zSymbol: cstring) -> proc "c" (),
	xDlClose:      proc "c" (^sqlite3_vfs, rawptr),
	xRandomness:   proc "c" (_: ^sqlite3_vfs, nByte: i32, zOut: cstring) -> i32,
	xSleep:        proc "c" (_: ^sqlite3_vfs, microseconds: i32) -> i32,
	xCurrentTime:  proc "c" (^sqlite3_vfs, ^f64) -> i32,
	xGetLastError: proc "c" (^sqlite3_vfs, i32, cstring) -> i32,

	/*
	** The methods above are in version 1 of the sqlite_vfs object
	** definition.  Those that follow are added in version 2 or later
	*/
	xCurrentTimeInt64: proc "c" (^sqlite3_vfs, ^sqlite3_int64) -> i32,

	/*
	** The methods above are in versions 1 and 2 of the sqlite_vfs object.
	** Those below are for version 3 and greater.
	*/
	xSetSystemCall:  proc "c" (_: ^sqlite3_vfs, zName: cstring, _: sqlite3_syscall_ptr) -> i32,
	xGetSystemCall:  proc "c" (_: ^sqlite3_vfs, zName: cstring) -> sqlite3_syscall_ptr,
	xNextSystemCall: proc "c" (_: ^sqlite3_vfs, zName: cstring) -> cstring,
}
...
foreign lib {
	...
	*/
	sqlite3_config :: proc(i32, #c_vararg ..any) -> i32 ---
...
sqlite3_mem_methods :: struct {
	xMalloc:   proc "c" (i32) -> rawptr,         /* Memory allocation function */
	xFree:     proc "c" (rawptr),                /* Free a prior allocation */
	xRealloc:  proc "c" (rawptr, i32) -> rawptr, /* Resize an allocation */
	xSize:     proc "c" (rawptr) -> i32,         /* Return the size of an allocation */
	xRoundup:  proc "c" (i32) -> i32,            /* Round up request size to allocation size */
	xInit:     proc "c" (rawptr) -> i32,         /* Initialize the memory allocator */
...
SQLITE_DBCONFIG_MAX                   :: 1022 /* Largest DBCONFIG */
...
foreign lib {
	...
	** last insert [rowid].
	*/
	sqlite3_last_insert_rowid :: proc(^sqlite3) -> sqlite3_int64 ---
	...
	*/
	sqlite3_set_last_insert_rowid :: proc(^sqlite3, sqlite3_int64) ---
	...
	** </ul>
	*/
	sqlite3_changes   :: proc(^sqlite3) -> i32 ---
	sqlite3_changes64 :: proc(^sqlite3) -> sqlite3_int64 ---
	...
	** </ul>
	*/
	sqlite3_total_changes   :: proc(^sqlite3) -> i32 ---
	sqlite3_total_changes64 :: proc(^sqlite3) -> sqlite3_int64 ---
	...
	*/
	sqlite3_interrupt      :: proc(^sqlite3) ---
	sqlite3_is_interrupted :: proc(^sqlite3) -> i32 ---
	...
	*/
	sqlite3_busy_handler :: proc(^sqlite3, proc "c" (rawptr, i32) -> i32, rawptr) -> i32 ---
...
foreign lib {
	...
	** [sqlite3_errmsg()].
	*/
	sqlite3_get_table  :: proc(db: ^sqlite3, zSql: cstring, pazResult: ^^cstring, pnRow: ^i32, pnColumn: ^i32, pzErrmsg: ^cstring) -> i32 ---
	sqlite3_free_table :: proc(result: ^cstring) ---
	...
	*/
	sqlite3_mprintf   :: proc(cstring, #c_vararg ..any) -> cstring ---
	sqlite3_vmprintf  :: proc(cstring, c.va_list) -> cstring ---
	sqlite3_snprintf  :: proc(i32, cstring, cstring, #c_vararg ..any) -> cstring ---
	sqlite3_vsnprintf :: proc(i32, cstring, cstring, c.va_list) -> cstring ---
	...
	*/
	sqlite3_malloc    :: proc(i32) -> rawptr ---
	sqlite3_malloc64  :: proc(sqlite3_uint64) -> rawptr ---
	sqlite3_realloc   :: proc(rawptr, i32) -> rawptr ---
	sqlite3_realloc64 :: proc(rawptr, sqlite3_uint64) -> rawptr ---
	sqlite3_free      :: proc(rawptr) ---
	sqlite3_msize     :: proc(rawptr) -> sqlite3_uint64 ---
	...
	*/
	sqlite3_set_authorizer :: proc(_: ^sqlite3, xAuth: proc "c" (rawptr, i32, cstring, cstring, cstring, cstring) -> i32, pUserData: rawptr) -> i32 ---
}
...
foreign lib {
	...
	** profile callback.
	*/
	sqlite3_trace   :: proc(_: ^sqlite3, xTrace: proc "c" (rawptr, cstring), _: rawptr) -> rawptr ---
	sqlite3_profile :: proc(_: ^sqlite3, xProfile: proc "c" (rawptr, cstring, sqlite3_uint64), _: rawptr) -> rawptr ---
}
...
foreign lib {
	...
	** are deprecated.
	*/
	sqlite3_trace_v2 :: proc(_: ^sqlite3, uMask: u32, xCallback: proc "c" (u32, rawptr, rawptr, rawptr) -> i32, pCtx: rawptr) -> i32 ---
	...
	*/
	sqlite3_progress_handler :: proc(^sqlite3, i32, proc "c" (rawptr) -> i32, rawptr) ---
	...
	*/
	...
	sqlite3_uri_int64     :: proc(sqlite3_filename, cstring, sqlite3_int64) -> sqlite3_int64 ---
	...
	*/
	sqlite3_filename_database :: proc(sqlite3_filename) -> cstring ---
	sqlite3_filename_journal  :: proc(sqlite3_filename) -> cstring ---
	sqlite3_filename_wal      :: proc(sqlite3_filename) -> cstring ---
	...
	** behavior.
	*/
	sqlite3_database_file_object :: proc(cstring) -> ^sqlite3_file ---
	...
	*/
	...
	sqlite3_free_filename   :: proc(sqlite3_filename) ---
	...
	*/
	...
	sqlite3_errmsg           :: proc(^sqlite3) -> cstring ---
	sqlite3_errmsg16         :: proc(^sqlite3) -> rawptr ---
	sqlite3_errstr           :: proc(i32) -> cstring ---
...
foreign lib {
	...
	*/
	...
	sqlite3_expanded_sql :: proc(pStmt: ^sqlite3_stmt) -> cstring ---
	...
	*/
	sqlite3_stmt_busy :: proc(^sqlite3_stmt) -> i32 ---
}
...
foreign lib {
	...
	*/
	sqlite3_bind_blob       :: proc(_: ^sqlite3_stmt, _: i32, _: rawptr, n: i32, _: proc "c" (rawptr)) -> i32 ---
	sqlite3_bind_blob64     :: proc(^sqlite3_stmt, i32, rawptr, sqlite3_uint64, proc "c" (rawptr)) -> i32 ---
	sqlite3_bind_double     :: proc(^sqlite3_stmt, i32, f64) -> i32 ---
	sqlite3_bind_int        :: proc(^sqlite3_stmt, i32, i32) -> i32 ---
	sqlite3_bind_int64      :: proc(^sqlite3_stmt, i32, sqlite3_int64) -> i32 ---
	sqlite3_bind_null       :: proc(^sqlite3_stmt, i32) -> i32 ---
	sqlite3_bind_text       :: proc(^sqlite3_stmt, i32, cstring, i32, proc "c" (rawptr)) -> i32 ---
	sqlite3_bind_text16     :: proc(^sqlite3_stmt, i32, rawptr, i32, proc "c" (rawptr)) -> i32 ---
	sqlite3_bind_text64     :: proc(_: ^sqlite3_stmt, _: i32, _: cstring, _: sqlite3_uint64, _: proc "c" (rawptr), encoding: u8) -> i32 ---
	sqlite3_bind_value      :: proc(^sqlite3_stmt, i32, ^sqlite3_value) -> i32 ---
	sqlite3_bind_pointer    :: proc(^sqlite3_stmt, i32, rawptr, cstring, proc "c" (rawptr)) -> i32 ---
	sqlite3_bind_zeroblob   :: proc(_: ^sqlite3_stmt, _: i32, n: i32) -> i32 ---
	sqlite3_bind_zeroblob64 :: proc(^sqlite3_stmt, i32, sqlite3_uint64) -> i32 ---
	...
	*/
	sqlite3_bind_parameter_count :: proc(^sqlite3_stmt) -> i32 ---
	...
	** [sqlite3_bind_parameter_index()].
	*/
	sqlite3_bind_parameter_name :: proc(^sqlite3_stmt, i32) -> cstring ---
	...
	*/
	sqlite3_clear_bindings :: proc(^sqlite3_stmt) -> i32 ---
	...
	*/
	sqlite3_column_database_name   :: proc(^sqlite3_stmt, i32) -> cstring ---
	sqlite3_column_database_name16 :: proc(^sqlite3_stmt, i32) -> rawptr ---
	sqlite3_column_table_name      :: proc(^sqlite3_stmt, i32) -> cstring ---
	sqlite3_column_table_name16    :: proc(^sqlite3_stmt, i32) -> rawptr ---
	sqlite3_column_origin_name     :: proc(^sqlite3_stmt, i32) -> cstring ---
	sqlite3_column_origin_name16   :: proc(^sqlite3_stmt, i32) -> rawptr ---
	...
	*/
	sqlite3_column_decltype   :: proc(^sqlite3_stmt, i32) -> cstring ---
	sqlite3_column_decltype16 :: proc(^sqlite3_stmt, i32) -> rawptr ---
	...
	*/
	sqlite3_step :: proc(^sqlite3_stmt) -> i32 ---
...
foreign lib {
	...
	*/
	sqlite3_create_function        :: proc(db: ^sqlite3, zFunctionName: cstring, nArg: i32, eTextRep: i32, pApp: rawptr, xFunc: proc "c" (^sqlite3_context, i32, ^^sqlite3_value), xStep: proc "c" (^sqlite3_context, i32, ^^sqlite3_value), xFinal: proc "c" (^sqlite3_context)) -> i32 ---
	sqlite3_create_function16      :: proc(db: ^sqlite3, zFunctionName: rawptr, nArg: i32, eTextRep: i32, pApp: rawptr, xFunc: proc "c" (^sqlite3_context, i32, ^^sqlite3_value), xStep: proc "c" (^sqlite3_context, i32, ^^sqlite3_value), xFinal: proc "c" (^sqlite3_context)) -> i32 ---
	sqlite3_create_function_v2     :: proc(db: ^sqlite3, zFunctionName: cstring, nArg: i32, eTextRep: i32, pApp: rawptr, xFunc: proc "c" (^sqlite3_context, i32, ^^sqlite3_value), xStep: proc "c" (^sqlite3_context, i32, ^^sqlite3_value), xFinal: proc "c" (^sqlite3_context), xDestroy: proc "c" (rawptr)) -> i32 ---
	sqlite3_create_window_function :: proc(db: ^sqlite3, zFunctionName: cstring, nArg: i32, eTextRep: i32, pApp: rawptr, xStep: proc "c" (^sqlite3_context, i32, ^^sqlite3_value), xFinal: proc "c" (^sqlite3_context), xValue: proc "c" (^sqlite3_context), xInverse: proc "c" (^sqlite3_context, i32, ^^sqlite3_value), xDestroy: proc "c" (rawptr)) -> i32 ---
}
...
@(default_calling_convention="c")
foreign lib {
	sqlite3_aggregate_count   :: proc(^sqlite3_context) -> i32 ---
	sqlite3_expired           :: proc(^sqlite3_stmt) -> i32 ---
	sqlite3_transfer_bindings :: proc(^sqlite3_stmt, ^sqlite3_stmt) -> i32 ---
	sqlite3_global_recover    :: proc() -> i32 ---
	sqlite3_thread_cleanup    :: proc() ---
	sqlite3_memory_alarm      :: proc(proc "c" (rawptr, sqlite3_int64, i32), rawptr, sqlite3_int64) -> i32 ---
	...
	** other SQLite interface is called on the same [database connection].
	*/
	sqlite3_value_blob         :: proc(^sqlite3_value) -> rawptr ---
	sqlite3_value_double       :: proc(^sqlite3_value) -> f64 ---
	sqlite3_value_int          :: proc(^sqlite3_value) -> i32 ---
	sqlite3_value_int64        :: proc(^sqlite3_value) -> sqlite3_int64 ---
	sqlite3_value_pointer      :: proc(^sqlite3_value, cstring) -> rawptr ---
	sqlite3_value_text         :: proc(^sqlite3_value) -> ^u8 ---
	sqlite3_value_text16       :: proc(^sqlite3_value) -> rawptr ---
	sqlite3_value_text16le     :: proc(^sqlite3_value) -> rawptr ---
	sqlite3_value_text16be     :: proc(^sqlite3_value) -> rawptr ---
	sqlite3_value_bytes        :: proc(^sqlite3_value) -> i32 ---
	sqlite3_value_bytes16      :: proc(^sqlite3_value) -> i32 ---
	sqlite3_value_type         :: proc(^sqlite3_value) -> i32 ---
	sqlite3_value_numeric_type :: proc(^sqlite3_value) -> i32 ---
	sqlite3_value_nochange     :: proc(^sqlite3_value) -> i32 ---
	sqlite3_value_frombind     :: proc(^sqlite3_value) -> i32 ---
	...
	*/
	sqlite3_value_encoding :: proc(^sqlite3_value) -> i32 ---
	...
	*/
	sqlite3_value_subtype :: proc(^sqlite3_value) -> u32 ---
	...
	*/
	sqlite3_value_dup  :: proc(^sqlite3_value) -> ^sqlite3_value ---
	sqlite3_value_free :: proc(^sqlite3_value) ---
	...
	*/
	sqlite3_user_data :: proc(^sqlite3_context) -> rawptr ---
	...
	** registered the application defined function.
	*/
	sqlite3_context_db_handle :: proc(^sqlite3_context) -> ^sqlite3 ---
	...
	*/
	...
	sqlite3_set_auxdata :: proc(_: ^sqlite3_context, N: i32, _: rawptr, _: proc "c" (rawptr)) ---
	...
	*/
	sqlite3_get_clientdata :: proc(^sqlite3, cstring) -> rawptr ---
	sqlite3_set_clientdata :: proc(^sqlite3, cstring, rawptr, proc "c" (rawptr)) -> i32 ---
}
...
** C++ compilers.
*/
sqlite3_destructor_type :: proc "c" (rawptr)
...
foreign lib {
	...
	*/
	sqlite3_result_blob         :: proc(^sqlite3_context, rawptr, i32, proc "c" (rawptr)) ---
	sqlite3_result_blob64       :: proc(^sqlite3_context, rawptr, sqlite3_uint64, proc "c" (rawptr)) ---
	sqlite3_result_double       :: proc(^sqlite3_context, f64) ---
	sqlite3_result_error        :: proc(^sqlite3_context, cstring, i32) ---
	sqlite3_result_error16      :: proc(^sqlite3_context, rawptr, i32) ---
	sqlite3_result_error_toobig :: proc(^sqlite3_context) ---
	sqlite3_result_error_nomem  :: proc(^sqlite3_context) ---
	sqlite3_result_error_code   :: proc(^sqlite3_context, i32) ---
	sqlite3_result_int          :: proc(^sqlite3_context, i32) ---
	sqlite3_result_int64        :: proc(^sqlite3_context, sqlite3_int64) ---
	sqlite3_result_null         :: proc(^sqlite3_context) ---
	sqlite3_result_text         :: proc(^sqlite3_context, cstring, i32, proc "c" (rawptr)) ---
	sqlite3_result_text64       :: proc(_: ^sqlite3_context, _: cstring, _: sqlite3_uint64, _: proc "c" (rawptr), encoding: u8) ---
	sqlite3_result_text16       :: proc(^sqlite3_context, rawptr, i32, proc "c" (rawptr)) ---
	sqlite3_result_text16le     :: proc(^sqlite3_context, rawptr, i32, proc "c" (rawptr)) ---
	sqlite3_result_text16be     :: proc(^sqlite3_context, rawptr, i32, proc "c" (rawptr)) ---
	sqlite3_result_value        :: proc(^sqlite3_context, ^sqlite3_value) ---
	sqlite3_result_pointer      :: proc(^sqlite3_context, rawptr, cstring, proc "c" (rawptr)) ---
	...
	** by default.
	*/
	sqlite3_result_subtype :: proc(^sqlite3_context, u32) ---
	...
	*/
	sqlite3_create_collation    :: proc(_: ^sqlite3, zName: cstring, eTextRep: i32, pArg: rawptr, xCompare: proc "c" (rawptr, i32, rawptr, i32, rawptr) -> i32) -> i32 ---
	sqlite3_create_collation_v2 :: proc(_: ^sqlite3, zName: cstring, eTextRep: i32, pArg: rawptr, xCompare: proc "c" (rawptr, i32, rawptr, i32, rawptr) -> i32, xDestroy: proc "c" (rawptr)) -> i32 ---
	sqlite3_create_collation16  :: proc(_: ^sqlite3, zName: rawptr, eTextRep: i32, pArg: rawptr, xCompare: proc "c" (rawptr, i32, rawptr, i32, rawptr) -> i32) -> i32 ---
	...
	*/
	sqlite3_collation_needed   :: proc(^sqlite3, rawptr, proc "c" (_: rawptr, _: ^sqlite3, eTextRep: i32, _: cstring)) -> i32 ---
	sqlite3_collation_needed16 :: proc(^sqlite3, rawptr, proc "c" (_: rawptr, _: ^sqlite3, eTextRep: i32, _: rawptr)) -> i32 ---
	...
	*/
	sqlite3_win32_set_directory   :: proc(type: c.ulong, zValue: rawptr) -> i32 ---
	sqlite3_win32_set_directory8  :: proc(type: c.ulong, zValue: cstring) -> i32 ---
	sqlite3_win32_set_directory16 :: proc(type: c.ulong, zValue: rawptr) -> i32 ---
}
...
foreign lib {
	...
	** is undefined.
	*/
	sqlite3_get_autocommit :: proc(^sqlite3) -> i32 ---
	...
	*/
	sqlite3_db_handle :: proc(^sqlite3_stmt) -> ^sqlite3 ---
...
foreign lib {
	...
	*/
	sqlite3_commit_hook   :: proc(^sqlite3, proc "c" (rawptr) -> i32, rawptr) -> rawptr ---
	sqlite3_rollback_hook :: proc(^sqlite3, proc "c" (rawptr), rawptr) -> rawptr ---
	...
	** </pre></blockquote>
	*/
	sqlite3_autovacuum_pages :: proc(db: ^sqlite3, _: proc "c" (rawptr, cstring, u32, u32, u32) -> u32, _: rawptr, _: proc "c" (rawptr)) -> i32 ---
	...
	*/
	sqlite3_update_hook :: proc(^sqlite3, proc "c" (rawptr, i32, cstring, cstring, sqlite3_int64), rawptr) -> rawptr ---
	...
	*/
	sqlite3_enable_shared_cache :: proc(i32) -> i32 ---
	...
	*/
	sqlite3_release_memory :: proc(i32) -> i32 ---
	...
	*/
	sqlite3_db_release_memory :: proc(^sqlite3) -> i32 ---
	...
	*/
	sqlite3_load_extension :: proc(db: ^sqlite3, zFile: cstring, zProc: cstring, pzErrMsg: ^cstring) -> i32 ---
...
sqlite3_module :: struct {
	iVersion:      i32,
	xCreate:       proc "c" (_: ^sqlite3, pAux: rawptr, argc: i32, argv: ^cstring, ppVTab: ^^sqlite3_vtab, _: ^cstring) -> i32,
	xConnect:      proc "c" (_: ^sqlite3, pAux: rawptr, argc: i32, argv: ^cstring, ppVTab: ^^sqlite3_vtab, _: ^cstring) -> i32,
	xBestIndex:    proc "c" (pVTab: ^sqlite3_vtab, _: ^sqlite3_index_info) -> i32,
	xDisconnect:   proc "c" (pVTab: ^sqlite3_vtab) -> i32,
	xDestroy:      proc "c" (pVTab: ^sqlite3_vtab) -> i32,
	xOpen:         proc "c" (pVTab: ^sqlite3_vtab, ppCursor: ^^sqlite3_vtab_cursor) -> i32,
	xClose:        proc "c" (^sqlite3_vtab_cursor) -> i32,
	xFilter:       proc "c" (_: ^sqlite3_vtab_cursor, idxNum: i32, idxStr: cstring, argc: i32, argv: ^^sqlite3_value) -> i32,
	xNext:         proc "c" (^sqlite3_vtab_cursor) -> i32,
	xEof:          proc "c" (^sqlite3_vtab_cursor) -> i32,
	xColumn:       proc "c" (^sqlite3_vtab_cursor, ^sqlite3_context, i32) -> i32,
	xRowid:        proc "c" (_: ^sqlite3_vtab_cursor, pRowid: ^sqlite3_int64) -> i32,
	xUpdate:       proc "c" (^sqlite3_vtab, i32, ^^sqlite3_value, ^sqlite3_int64) -> i32,
	xBegin:        proc "c" (pVTab: ^sqlite3_vtab) -> i32,
	xSync:         proc "c" (pVTab: ^sqlite3_vtab) -> i32,
	xCommit:       proc "c" (pVTab: ^sqlite3_vtab) -> i32,
	xRollback:     proc "c" (pVTab: ^sqlite3_vtab) -> i32,
	xFindFunction: proc "c" (pVtab: ^sqlite3_vtab, nArg: i32, zName: cstring, pxFunc: ^proc "c" (^sqlite3_context, i32, ^^sqlite3_value), ppArg: ^rawptr) -> i32,
	xRename:       proc "c" (pVtab: ^sqlite3_vtab, zNew: cstring) -> i32,

	/* The methods above are in version 1 of the sqlite_module object. Those
	** below are for version 2 and greater. */
	xSavepoint:  proc "c" (pVTab: ^sqlite3_vtab, _: i32) -> i32,
	xRelease:    proc "c" (pVTab: ^sqlite3_vtab, _: i32) -> i32,
	xRollbackTo: proc "c" (pVTab: ^sqlite3_vtab, _: i32) -> i32,
	...
	** Those below are for version 4 and greater. */
	xIntegrity: proc "c" (pVTab: ^sqlite3_vtab, zSchema: cstring, zTabName: cstring, mFlags: i32, pzErr: ^cstring) -> i32,
}
...
sqlite3_index_info :: struct {
	/* Inputs */
	nConstraint:      i32,                       /* Number of entries in aConstraint */
	aConstraint:      ^sqlite3_index_constraint, /* Table of WHERE clause constraints */
	nOrderBy:         i32,                       /* Number of terms in the ORDER BY clause */
	aOrderBy:         ^sqlite3_index_orderby,    /* The ORDER BY clause */
	aConstraintUsage: ^sqlite3_index_constraint_usage,
	idxNum:           i32,                       /* Number used to identify the index */
	idxStr:           cstring,                   /* String, possibly obtained from sqlite3_malloc */
	needToFreeIdxStr: i32,                       /* Free idxStr using sqlite3_free() if true */
	orderByConsumed:  i32,                       /* True if output is already ordered */
	estimatedCost:    f64,                       /* Estimated cost of using this index */

	/* Fields below are only available in SQLite 3.8.2 and later */
	estimatedRows: sqlite3_int64, /* Estimated number of rows returned */

	/* Fields below are only available in SQLite 3.9.0 and later */
	idxFlags: i32, /* Mask of SQLITE_INDEX_SCAN_* flags */
...
foreign lib {
	...
	*/
	...
	sqlite3_create_module_v2 :: proc(db: ^sqlite3, zName: cstring, p: ^sqlite3_module, pClientData: rawptr, xDestroy: proc "c" (rawptr)) -> i32 ---
...
sqlite3_vtab :: struct {
	...
	nRef:    i32,             /* Number of open cursors */
	zErrMsg: cstring,         /* Error message from sqlite3_mprintf() */
}
...
foreign lib {
	...
	*/
	sqlite3_blob_reopen :: proc(^sqlite3_blob, sqlite3_int64) -> i32 ---
	...
	*/
	sqlite3_blob_close :: proc(^sqlite3_blob) -> i32 ---
	...
	*/
	sqlite3_blob_bytes :: proc(^sqlite3_blob) -> i32 ---
	...
	*/
	...
	sqlite3_vfs_unregister :: proc(^sqlite3_vfs) -> i32 ---
	...
	*/
	sqlite3_mutex_alloc :: proc(i32) -> ^sqlite3_mutex ---
	sqlite3_mutex_free  :: proc(^sqlite3_mutex) ---
	sqlite3_mutex_enter :: proc(^sqlite3_mutex) ---
	sqlite3_mutex_try   :: proc(^sqlite3_mutex) -> i32 ---
	sqlite3_mutex_leave :: proc(^sqlite3_mutex) ---
}

sqlite3_mutex_methods :: struct {
	xMutexInit:    proc "c" () -> i32,
	xMutexEnd:     proc "c" () -> i32,
	xMutexAlloc:   proc "c" (i32) -> ^sqlite3_mutex,
	xMutexFree:    proc "c" (^sqlite3_mutex),
	xMutexEnter:   proc "c" (^sqlite3_mutex),
	xMutexTry:     proc "c" (^sqlite3_mutex) -> i32,
	xMutexLeave:   proc "c" (^sqlite3_mutex),
	xMutexHeld:    proc "c" (^sqlite3_mutex) -> i32,
	xMutexNotheld: proc "c" (^sqlite3_mutex) -> i32,
}

@(default_calling_convention="c")
foreign lib {
	sqlite3_mutex_held    :: proc(^sqlite3_mutex) -> i32 ---
	sqlite3_mutex_notheld :: proc(^sqlite3_mutex) -> i32 ---
}
...
foreign lib {
	...
	*/
	sqlite3_db_mutex :: proc(^sqlite3) -> ^sqlite3_mutex ---
...
foreign lib {
	...
	*/
	...
	sqlite3_keyword_name  :: proc(i32, ^cstring, ^i32) -> i32 ---
	sqlite3_keyword_check :: proc(cstring, i32) -> i32 ---
}
...
foreign lib {
	...
	*/
	sqlite3_str_new :: proc(^sqlite3) -> ^sqlite3_str ---
	...
	*/
	sqlite3_str_finish :: proc(^sqlite3_str) -> cstring ---
	...
	*/
	...
	sqlite3_str_vappendf   :: proc(_: ^sqlite3_str, zFormat: cstring, _: c.va_list) ---
	sqlite3_str_append     :: proc(_: ^sqlite3_str, zIn: cstring, N: i32) ---
	sqlite3_str_appendall  :: proc(_: ^sqlite3_str, zIn: cstring) ---
	sqlite3_str_appendchar :: proc(_: ^sqlite3_str, N: i32, C: i8) ---
	sqlite3_str_reset      :: proc(^sqlite3_str) ---
	...
	*/
	sqlite3_str_errcode :: proc(^sqlite3_str) -> i32 ---
	sqlite3_str_length  :: proc(^sqlite3_str) -> i32 ---
	sqlite3_str_value   :: proc(^sqlite3_str) -> cstring ---
...
foreign lib {
	...
	*/
	...
	sqlite3_db_status64 :: proc(^sqlite3, i32, ^sqlite3_int64, ^sqlite3_int64, i32) -> i32 ---
}
...
sqlite3_pcache_methods2 :: struct {
	...
	xCreate:    proc "c" (szPage: i32, szExtra: i32, bPurgeable: i32) -> ^sqlite3_pcache,
	xCachesize: proc "c" (_: ^sqlite3_pcache, nCachesize: i32),
	xPagecount: proc "c" (^sqlite3_pcache) -> i32,
	xFetch:     proc "c" (_: ^sqlite3_pcache, key: u32, createFlag: i32) -> ^sqlite3_pcache_page,
	xUnpin:     proc "c" (_: ^sqlite3_pcache, _: ^sqlite3_pcache_page, discard: i32),
	xRekey:     proc "c" (_: ^sqlite3_pcache, _: ^sqlite3_pcache_page, oldKey: u32, newKey: u32),
	xTruncate:  proc "c" (_: ^sqlite3_pcache, iLimit: u32),
	xDestroy:   proc "c" (^sqlite3_pcache),
	xShrink:    proc "c" (^sqlite3_pcache),
}
...
sqlite3_pcache_methods :: struct {
	...
	xInit:      proc "c" (rawptr) -> i32,
	xShutdown:  proc "c" (rawptr),
	xCreate:    proc "c" (szPage: i32, bPurgeable: i32) -> ^sqlite3_pcache,
	xCachesize: proc "c" (_: ^sqlite3_pcache, nCachesize: i32),
	xPagecount: proc "c" (^sqlite3_pcache) -> i32,
	xFetch:     proc "c" (_: ^sqlite3_pcache, key: u32, createFlag: i32) -> rawptr,
	xUnpin:     proc "c" (_: ^sqlite3_pcache, _: rawptr, discard: i32),
	xRekey:     proc "c" (_: ^sqlite3_pcache, _: rawptr, oldKey: u32, newKey: u32),
	xTruncate:  proc "c" (_: ^sqlite3_pcache, iLimit: u32),
	xDestroy:   proc "c" (^sqlite3_pcache),
}
...
foreign lib {
	...
	** SQLITE_LOCKED.)^
	*/
	sqlite3_unlock_notify :: proc(pBlocked: ^sqlite3, xNotify: proc "c" (apArg: ^rawptr, nArg: i32), pNotifyArg: rawptr) -> i32 ---
	...
	*/
	sqlite3_stricmp  :: proc(cstring, cstring) -> i32 ---
	sqlite3_strnicmp :: proc(cstring, cstring, i32) -> i32 ---
	...
	*/
	sqlite3_wal_hook :: proc(^sqlite3, proc "c" (rawptr, ^sqlite3, cstring, i32) -> i32, rawptr) -> rawptr ---
...
foreign lib {
	...
	** [virtual table].
	*/
	sqlite3_vtab_on_conflict :: proc(^sqlite3) -> i32 ---
	...
	*/
	sqlite3_vtab_nochange :: proc(^sqlite3_context) -> i32 ---
	...
	** </ol>
	*/
	sqlite3_vtab_collation :: proc(^sqlite3_index_info, i32) -> cstring ---
	...
	** results.
	*/
	sqlite3_vtab_distinct :: proc(^sqlite3_index_info) -> i32 ---
...
foreign lib {
	...
	*/
	sqlite3_stmt_scanstatus_reset :: proc(^sqlite3_stmt) ---
	...
	*/
	sqlite3_db_cacheflush :: proc(^sqlite3) -> i32 ---
	...
	*/
	sqlite3_system_errno :: proc(^sqlite3) -> i32 ---
}
...
foreign lib {
	...
	** [SQLITE_ENABLE_SNAPSHOT] compile-time option is used.
	*/
	sqlite3_snapshot_free :: proc(^sqlite3_snapshot) ---
...
foreign lib {
	...
	*/
	sqlite3_carray_bind :: proc(pStmt: ^sqlite3_stmt, i: i32, aData: rawptr, nData: i32, mFlags: i32, xDel: proc "c" (rawptr)) -> i32 ---
}
...
*/
SQLITE_CARRAY_INT32     :: 0    /* Data is 32-bit signed integers */
SQLITE_CARRAY_INT64     :: 1    /* Data is 64-bit signed integers */
SQLITE_CARRAY_DOUBLE    :: 2    /* Data is doubles */
SQLITE_CARRAY_TEXT      :: 3    /* Data is char* */
SQLITE_CARRAY_BLOB      :: 4    /* Data is struct iovec */
...
foreign lib {
	...
	*/
	sqlite3_rtree_geometry_callback :: proc(db: ^sqlite3, zGeom: cstring, xGeom: proc "c" (^sqlite3_rtree_geometry, i32, ^sqlite3_rtree_dbl, ^i32) -> i32, pContext: rawptr) -> i32 ---
}
...
sqlite3_rtree_geometry :: struct {
	...
	nParam:   i32,                /* Size of array aParam[] */
	aParam:   ^sqlite3_rtree_dbl, /* Parameters passed to SQL geom function */
...
foreign lib {
	...
	*/
	sqlite3_rtree_query_callback :: proc(db: ^sqlite3, zQueryFunc: cstring, xQueryFunc: proc "c" (^sqlite3_rtree_query_info) -> i32, pContext: rawptr, xDestructor: proc "c" (rawptr)) -> i32 ---
}
...
sqlite3_rtree_query_info :: struct {
	...
	nParam:        i32,                /* Number of function parameters */
	aParam:        ^sqlite3_rtree_dbl, /* value of function parameters */
	pUser:         rawptr,             /* callback can use this, if desired */
	xDelUser:      proc "c" (rawptr),  /* function to free pUser */
	aCoord:        ^sqlite3_rtree_dbl, /* Coordinates of node or entry to check */
	anQueue:       ^u32,               /* Number of pending entries in the queue */
	nCoord:        i32,                /* Number of coordinates */
	iLevel:        i32,                /* Level of current node or entry */
	mxLevel:       i32,                /* The largest iLevel value in the tree */
	iRowid:        sqlite3_int64,      /* Rowid for current entry */
	rParentScore:  sqlite3_rtree_dbl,  /* Score of parent node */
	eParentWithin: i32,                /* Visibility of parent node */
	eWithin:       i32,                /* OUT: Visibility */
	rScore:        sqlite3_rtree_dbl,  /* OUT: Write the score here */

	/* The following fields are only available in 3.8.11 and later */
	apSqlParam: ^^sqlite3_value, /* Original SQL values of parameters */
}
...
Fts5Context             :: struct {}
fts5_extension_function :: proc "c" (pApi: ^Fts5ExtensionApi, pFts: ^Fts5Context, pCtx: ^sqlite3_context, nVal: i32, apVal: ^^sqlite3_value)
...
Fts5ExtensionApi :: struct {
	iVersion:           i32, /* Currently always set to 4 */
	xUserData:          proc "c" (^Fts5Context) -> rawptr,
	xColumnCount:       proc "c" (^Fts5Context) -> i32,
	xRowCount:          proc "c" (_: ^Fts5Context, pnRow: ^sqlite3_int64) -> i32,
	xColumnTotalSize:   proc "c" (_: ^Fts5Context, iCol: i32, pnToken: ^sqlite3_int64) -> i32,
	xTokenize:          proc "c" (_: ^Fts5Context, pText: cstring, nText: i32, pCtx: rawptr, xToken: proc "c" (rawptr, i32, cstring, i32, i32, i32) -> i32) -> i32,
	xPhraseCount:       proc "c" (^Fts5Context) -> i32,
	xPhraseSize:        proc "c" (_: ^Fts5Context, iPhrase: i32) -> i32,
	xInstCount:         proc "c" (_: ^Fts5Context, pnInst: ^i32) -> i32,
	xInst:              proc "c" (_: ^Fts5Context, iIdx: i32, piPhrase: ^i32, piCol: ^i32, piOff: ^i32) -> i32,
	xRowid:             proc "c" (^Fts5Context) -> sqlite3_int64,
	xColumnText:        proc "c" (_: ^Fts5Context, iCol: i32, pz: ^cstring, pn: ^i32) -> i32,
	xColumnSize:        proc "c" (_: ^Fts5Context, iCol: i32, pnToken: ^i32) -> i32,
	xQueryPhrase:       proc "c" (_: ^Fts5Context, iPhrase: i32, pUserData: rawptr, _: proc "c" (^Fts5ExtensionApi, ^Fts5Context, rawptr) -> i32) -> i32,
	xSetAuxdata:        proc "c" (_: ^Fts5Context, pAux: rawptr, xDelete: proc "c" (rawptr)) -> i32,
	xGetAuxdata:        proc "c" (_: ^Fts5Context, bClear: i32) -> rawptr,
	xPhraseFirst:       proc "c" (_: ^Fts5Context, iPhrase: i32, _: ^Fts5PhraseIter, _: ^i32, _: ^i32) -> i32,
	xPhraseNext:        proc "c" (_: ^Fts5Context, _: ^Fts5PhraseIter, piCol: ^i32, piOff: ^i32),
	xPhraseFirstColumn: proc "c" (_: ^Fts5Context, iPhrase: i32, _: ^Fts5PhraseIter, _: ^i32) -> i32,
	xPhraseNextColumn:  proc "c" (_: ^Fts5Context, _: ^Fts5PhraseIter, piCol: ^i32),

	/* Below this point are iVersion>=3 only */
	xQueryToken: proc "c" (_: ^Fts5Context, iPhrase: i32, iToken: i32, ppToken: ^cstring, pnToken: ^i32) -> i32,
	xInstToken:  proc "c" (_: ^Fts5Context, iIdx: i32, iToken: i32, _: ^cstring, _: ^i32) -> i32,

	/* Below this point are iVersion>=4 only */
	xColumnLocale: proc "c" (_: ^Fts5Context, iCol: i32, pz: ^cstring, pn: ^i32) -> i32,
	xTokenize_v2:  proc "c" (_: ^Fts5Context, pText: cstring, nText: i32, pLocale: cstring, nLocale: i32, pCtx: rawptr, xToken: proc "c" (rawptr, i32, cstring, i32, i32, i32) -> i32) -> i32,
}

Fts5Tokenizer :: struct {}

fts5_tokenizer_v2 :: struct {
	iVersion:  i32, /* Currently always 2 */
	xCreate:   proc "c" (_: rawptr, azArg: ^cstring, nArg: i32, ppOut: ^^Fts5Tokenizer) -> i32,
	xDelete:   proc "c" (^Fts5Tokenizer),
	xTokenize: proc "c" (_: ^Fts5Tokenizer, pCtx: rawptr, flags: i32, pText: cstring, nText: i32, pLocale: cstring, nLocale: i32, xToken: proc "c" (pCtx: rawptr, tflags: i32, pToken: cstring, nToken: i32, iStart: i32, iEnd: i32) -> i32) -> i32,
}

fts5_tokenizer :: struct {
	xCreate:   proc "c" (_: rawptr, azArg: ^cstring, nArg: i32, ppOut: ^^Fts5Tokenizer) -> i32,
	xDelete:   proc "c" (^Fts5Tokenizer),
	xTokenize: proc "c" (_: ^Fts5Tokenizer, pCtx: rawptr, flags: i32, pText: cstring, nText: i32, xToken: proc "c" (pCtx: rawptr, tflags: i32, pToken: cstring, nToken: i32, iStart: i32, iEnd: i32) -> i32) -> i32,
}
...
fts5_api :: struct {
	iVersion: i32, /* Currently always set to 3 */

	/* Create a new tokenizer */
	xCreateTokenizer: proc "c" (pApi: ^fts5_api, zName: cstring, pUserData: rawptr, pTokenizer: ^fts5_tokenizer, xDestroy: proc "c" (rawptr)) -> i32,

	/* Find an existing tokenizer */
	xFindTokenizer: proc "c" (pApi: ^fts5_api, zName: cstring, ppUserData: ^rawptr, pTokenizer: ^fts5_tokenizer) -> i32,

	/* Create a new auxiliary function */
	xCreateFunction: proc "c" (pApi: ^fts5_api, zName: cstring, pUserData: rawptr, xFunction: fts5_extension_function, xDestroy: proc "c" (rawptr)) -> i32,

	/* APIs below this point are only available if iVersion>=3 */
	
	/* Create a new tokenizer */
	xCreateTokenizer_v2: proc "c" (pApi: ^fts5_api, zName: cstring, pUserData: rawptr, pTokenizer: ^fts5_tokenizer_v2, xDestroy: proc "c" (rawptr)) -> i32,

	/* Find an existing tokenizer */
	xFindTokenizer_v2: proc "c" (pApi: ^fts5_api, zName: cstring, ppUserData: ^rawptr, ppTokenizer: ^^fts5_tokenizer_v2) -> i32,
}
